// mats: lmd, manganese ore, manganese tryhidrate, battle records, module data block, data supplement instrument, data supplement stick, nucleic crystal sinter, polymerization preparation, crystaline electronic unit, bipolar nanoflake, cyclicene prefab, aggregate cyclicene, solidfied fiber board, fuscous fiber, transmuted salt agglomerate, transmuted salt, cuttin fluid solution, compound cutting fluid, refined solvent, semi-synthetic solvent, crystaline component, incandescent alloy block, coagulating gel, loxic kohl, grindstone pentahydrate, grindstone, white horse kohl, device, damaged device, integrated device, optimized device, polyketon, diketon, aketon, keton colloid, oriron shard, oriron, oriron cluster, oriron block, orirock, orirock cube, orirock cluster, orirock concentration, ester, polyester, polyester pack, polyester lump, sugar, sugar pack, sugar substitute, sugar lump, d32 steel, rma70-24, rma70-12,
// chips: defender chip, defender chip pack, medic chip, medic chip pack, sniper chip, sniper chip pack, caster chip, caster chip pack, vanguard chip, vanguard chip pack, supporter chip, supporter chip pack, guard chip, guard chip pack, specialist chip, specialist chip pack
...
if(operator == AMIYA){
    let goals = prompt("insert your goals") 
    if(goals == E1){
        console.log(E1());
    }
...
let skilsummarys = ["skill summary-1", "skill summary-2", "skill summary-3"];
